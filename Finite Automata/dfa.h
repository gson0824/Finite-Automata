...
/**
 * Set the transitions of the given DFA for all input symbols except for ONE character
 * int n represents the ASCII value of that character
 */
extern void DFA_set_transition_all_except(DFA dfa, int src, int dst, int n);
